...
bool DjiRos::initPublisher(ros::NodeHandle &nh) {
  ...
  attitude_publisher = nh.advertise<geometry_msgs::QuaternionStamped>("attitude", 10);

  battery_state_publisher = nh.advertise<sensor_msgs::BatteryState>("battery_state",10);
