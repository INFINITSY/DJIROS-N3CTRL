...
#include "../../include/dji_sdk/dji_sdk_node.h"
...
{
  std::cout << "1 telemetry_from_fc " << telemetry_from_fc << std::endl;
  ...
  */
  ...
  std::cout << "telemetry_from_fc" << telemetry_from_fc << std::endl;
  std::cout << "USE_BROADCAST" << USE_BROADCAST << std::endl;
