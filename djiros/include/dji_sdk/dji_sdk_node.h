...
protected:
  ...
  TELEMETRY_TYPE telemetry_from_fc = USE_BROADCAST;
  bool user_select_BC;
  const tf::Matrix3x3 R_FLU2FRD = tf::Matrix3x3(1,  0,  0, 0, -1,  0, 0,  0, -1);
  const tf::Matrix3x3 R_ENU2NED = tf::Matrix3x3(0,  1,  0, 1,  0,  0, 0,  0, -1);
